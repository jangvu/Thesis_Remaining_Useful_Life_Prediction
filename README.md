...
My thesis is inspired by Prognostics and Health Management (PHM) problem, which is an important topic in industry for predicting state of assets to avoid downtime and failures.
